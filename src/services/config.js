...
export default class {
  constructor() {
    ...
    this.messageCount = this.getEnvironmentVariable(
      "DUKE_MESSAGE_HISTORY_COUNT"
    );
    ...
    this.emojis = {
      ...
      retweet: this.getEnvironmentVariable("DUKE_EMOJIS_RETWEET"),
      reply: this.getEnvironmentVariable("DUKE_EMOJIS_REPLY"),
    };
    ...
    this.useTwitter =
      "true" == this.getEnvironmentVariable("DUKE_USE_TWITTER").toLowerCase();
    if (this.useTwitter) {
      this.twitter = {
        consumerKey: this.getEnvironmentVariable("DUKE_TWITTER_CONSUMER_KEY"),
        consumerSecret: this.getEnvironmentVariable(
          "DUKE_TWITTER_CONSUMER_SECRET"
        ),
        accessTokenKey: this.getEnvironmentVariable(
          "DUKE_TWITTER_ACCESS_TOKEN_KEY"
        ),
        accessTokenSecret: this.getEnvironmentVariable(
          "DUKE_TWITTER_ACCESS_TOKEN_SECRET"
        ),
      };
    ...
    this.useStocks =
      "true" == this.getEnvironmentVariable("DUKE_USE_STOCKS").toLowerCase();
    if (this.useStocks) {
      this.stocks = {
